...
const About = () => {
  const frontLanguages = [html, css, js, ts];
  const frontTechnologies = [react, next, tailwind];

  const backLanguages = [cSharp, sqlIcon, js, ts];
  const backTechnologies = [node, sql, sqlServer];
  ...
  return (
    ...
    >
      ...
      <p className={styles.subtitle}>
        Olá, meu nome é Carlos, tenho 22 anos e sou desenvolvedor desde o ano de
        2022. Meu objetivo principal é me aprimorar sempre! Estou constantemente
      ...
      <div className={styles.aboutContent}>
        <Card
          ...
          languageIcons={frontLanguages}
          technologieIcons={frontTechnologies}
          isFrontEndCard={true}
          img={
            <svg
              width='30px'
        ...
        <Card
          ...
          languageIcons={backLanguages}
          technologieIcons={backTechnologies}
          img={
            <svg
              width='30px'
              height='30px'
